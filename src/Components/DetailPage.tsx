...
const DetailPage = (props: Props) => {
  ...
  return (
    <>
      ...
      <div className={`absolute top-16 md:top-24 z-20 right-0 left-0 md:w-[480px] w-[300px] h-[480px] mx-auto opacity-100 rounded-2xl p-4 ${theme === 'dark' ? 'text-white bg-gray-700' : 'text-black bg-amber-50'}`} >
